  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
    ...
    variables.country == null ? "Country." : variables.country
          ...
          <ul class=${variables.socialMediaPosition}
            <li><a href="variable.twitter"><i class="fab fa-twitter"></i></a></li>
            <li><a href="variable.github"><i class="fab fa-github"></i></a></li>
            <li><a href="variable.linkedin"><i class="fab fa-linkedin"></i></a></li>
            <li><a href="variable.instagram"><i class="fab fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
